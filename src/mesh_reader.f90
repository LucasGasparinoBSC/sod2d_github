module mesh_reader
      ...
      contains
              ...
              subroutine read_geo_dat(file_path,file_name,npoin,nelem,nboun,connec,bound,coord)
                      ...
                      integer(4)    , intent(out) :: connec(nelem,4), bound(nboun,2)
                      real(8)       , intent(out) :: coord(npoin,2)
                      integer(4)                  :: iline, int1
                      character(500)              :: file_type, line
                      ...
                      read(99,*)
                      do iline = 1,nelem
                         read(99,*) int1, connec(iline,1), connec(iline,2), connec(iline,3), connec(iline,4)
                      end do
                      ...
                      read(99,*)
                      do iline = 1,nboun
                         read(99,*) int1, bound(iline,1), bound(iline,2)
                      end do
                      close(99)
