program unitt_mom_convec
        ...
        real(8),    allocatable    :: u(:,:), q(:,:), pr(:), Rconvec(:,:)
        real(8)                    :: s, t, detJe
        ...
        allocate(Rconvec(npoin,ndime))
        call mom_convec(nelem,ngaus,npoin,nnode,ndime,connec,Ngp,gpcar,gpvol,u,q,pr,Rconvec)
