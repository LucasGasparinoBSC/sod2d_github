program unitt_mom_diffu
        ...
        do idime = 1,ndime
           if (abs(sum(Rdiffu(:,idime))) .gt. 0.00000000000001d0) then
                   write(*,*) "idime = ",idime
                   write(*,*) "|sum(Rdiffu)| = ", abs(sum(Rdiffu(:,idime)))
                   stop 1
           else
                   write(*,*) "idime = ",idime
                   write(*,*) "|sum(Rdiffu)| = ", abs(sum(Rdiffu(:,idime)))
